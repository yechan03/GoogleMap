...
//    SharedPreferences.Editor editor = pref.edit();
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyDkHfJNHgO1wq8I816WS2PP_htCmpqv1CE")
...
//형님?
    ...
    void show(){
        ...
        final TextView tv1 = view.findViewById(R.id.TV);
        final TextView tv2 = view.findViewById(R.id.TV2);
        final Button submit = (Button) view.findViewById(R.id.BT);
        final EditText feedback = (EditText) view.findViewById(R.id.feedback);
        final EditText food = (EditText) view.findViewById(R.id.food);

        final AlertDialog dialog = builder.create();

//        String a = pref.getString("food","");
//        String b = pref.getString("feedback","");
//
//        tv1.setText(a);
//        tv2.setText(b);
//
...
//
//
//                Food = feedback.getText().toString();
//                Feedback  = food.getText().toString();
//
//
